...
function onMobSpawn(mob)
	...
	mob:addListener("COMBAT_TICK", "EXCENMILLE_PROVOKE_TICK", function(mob, player, target)
	...
	mob:addListener("COMBAT_TICK", "EXCENMILLE_DEBUFF_TICK", function(mob, player, target)
	    local battletime = os.time()
	...
	mob:addListener("COMBAT_TICK", "EXCENMILLE_CURE_TICK", function(mob, player, target)
	    local battletime = os.time()
	...
	mob:addListener("COMBAT_TICK", "EXCENMILLE_COMBAT_TICK", function(mob, target)
