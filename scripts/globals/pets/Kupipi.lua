...
function onMobSpawn(mob)  
	...
	mob:addListener("ROAM_TICK", "KUPIPI_BUFF_TICK", function(mob, player, target)
	...
	mob:addListener("COMBAT_TICK", "KUPIPI_AILMENT_TICK", function(mob, player, target)
	    local battletime = os.time()
	...
	mob:addListener("COMBAT_TICK", "KUPIPI_DEBUFF_TICK", function(mob, player, target)
	    local battletime = os.time()
